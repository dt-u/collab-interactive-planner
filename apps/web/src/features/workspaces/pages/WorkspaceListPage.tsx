...
export const WorkspaceListPage: React.FC = () => {
  ...
  const handleDeleteWorkspace = async (workspaceId: string) => {
    if (!window.confirm("Are you sure you want to delete this workspace? This will permanently wipe all its plans, Yjs snapshots, and CRDT update logs!")) return;
    try {
      setLoading(true);
  ...
  const handleLeaveWorkspace = async (workspaceId: string) => {
    if (!window.confirm("Are you sure you want to leave this workspace? You will no longer have access to its plans!")) return;
    try {
      setLoading(true);
  ...
  const handleDeletePlan = async (planId: string) => {
    if (!window.confirm("Are you sure you want to delete this board plan? This will permanently erase all its data, snapshots, and update logs!")) return;
    try {
